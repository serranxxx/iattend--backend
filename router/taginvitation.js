...
const { postInvitations, putInvitations, getInvitations, getIvitationbyID, deleteInvitation, getIvitationsbyUserID, getDominios } = require('../controllers/tagInvitation');
