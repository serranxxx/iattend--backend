function activationRequestEmailTemplate({ vendedorNombre, username }) {
  const conversationUrl = `https://ig.me/m/${username}`;
  return `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Solicitud de activación — Tablero de Prospectos</title>
      ...
      <tr>
        <td style="background-color:#FFFFFF;padding:44px 48px 8px;text-align:center;">
          <h1 style="margin:0;font-family:'Fraunces',Georgia,'Times New Roman',serif;font-weight:400;font-size:26px;line-height:1.3;color:#1a1a1a;">
            Solicitud de <em style="font-style:italic;color:#7F77DD;">activación</em>
          </h1>
        </td>
      </tr>

      <tr>
        <td style="background-color:#FFFFFF;padding:16px 48px 36px;text-align:center;">
          <p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:15px;line-height:1.6;color:#5A5676;">
            <strong style="color:#26215C;">${vendedorNombre}</strong> ha solicitado iniciar la conversación con
            <strong style="color:#26215C;">@${username}</strong> en el Tablero de Prospectos.
          </p>
        </td>
      </tr>

      <tr>
        <td style="background-color:#FFFFFF;padding:0 48px 48px;text-align:center;">
          <a href="${conversationUrl}"
            style="display:inline-block;background:#7F77DD;color:#FFFFFF;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:15px;font-weight:600;letter-spacing:0.3px;text-decoration:none;padding:16px 38px;border-radius:12px;box-shadow:0 8px 20px rgba(127,119,221,0.35);">
            Abrir conversación &nbsp;→
          </a>
        </td>
      </tr>
...
module.exports = { activationRequestEmailTemplate };
