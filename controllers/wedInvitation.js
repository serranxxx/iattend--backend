...
const getIvitationbyID = async (req, res = express.response) => {
    ...
    try {
        ...
        const Invitation = await WeddingInvitation.findById(invitationID);
...
const getInvitations = async (req, res = express.response) => {
    ...
    const data = await WeddingInvitation.find({});
...
const putInvitations = async (req, res = response) => {
    try {
        ...
        const updatedItem = await WeddingInvitation.findByIdAndUpdate(
